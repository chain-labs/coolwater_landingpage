...
const BlurboxComp = () => {
	return (
		<div className="w-[263px] h-9 px-4 py-2.5  rounded-2xl shadow-inner border border-black border-opacity-5 backdrop-blur-md justify-start items-start gap-2.5 inline-flex">
